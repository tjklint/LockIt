...
namespace LockIt.Models
{
    internal class EnvironmentalSensor
    {
        ...
        public int TemperatureSensor {  get { return _temperatureSensor; } 
            set { _temperatureSensor = value; } }
        public int HumiditySensor { get {return _humiditySensor; } 
            set { _humiditySensor = value; } }
        public int LuminositySensor { get {return _luminositySensor; }
